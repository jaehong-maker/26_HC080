...
|:---:|:---:|:---:|:---:|:---:|
| **류재홍** | **김지훈** | **신양섭** | **이준선** | **이헌영** |
| • 팀 관리 및 프로젝트 총괄 <br> • 로드셀 및 서버 통신 딜레이 해결 | • 애플리케이션 UI 수정 <br> • 서버 및 기기 제어 연동 | • AI 엔진 연동 <br> • 서버 에러 수정 및 DynamoDB 관리 |• 클라우드 관리 <br> • 디스플레이 UI/UX 설계 및 기기 제어 | • 모듈 제어 검증 <br> • 하드웨어 기구 설계 및 외관 PCB 가공 |
